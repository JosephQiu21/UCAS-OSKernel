...
struct task_info task2_8 = {(ptr_t)&print_task1, USER_PROCESS};
struct task_info task2_9 = {(ptr_t)&print_task2, USER_PROCESS};
struct task_info task2_10 = {(ptr_t)&drawing_task, USER_PROCESS};
struct task_info *sched2_tasks[16] = {&task2_8, &task2_9, &task2_10};
int num_sched2_tasks = 3;

struct task_info task2_11 = {(ptr_t)&lock_task1, USER_THREAD};
